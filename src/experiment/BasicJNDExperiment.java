...
//    final private String expCond = "PointTeeCond";
    ...
    private int iPointsLeft = 100;      final private String iPointsLeftLabel = "iPointsLeft";
    private int iPointsRight = 100;     final private String iPointsRightLabel = "iPointsRight";
    private int iCapComplete = 30;      final private String iCapCompleteLabel = "iCapComplete";
    private int iScreenResX = 500;     final private String iScreenResXLabel = "iScreenResX";
    private int iScreenResY = 500;      final private String iScreenResYLabel = "iScreenResY";
    private int iTestNumTrials = 30;    final private String iTestNumTrialsLabel = "iTestNumTrials";
    
    private double dErrLeft = 0.0001;   final private String dErrLeftLabel = "dErrLeft";
    private double dErrRight = 0.0001;  final private String dErrRightLabel = "dErrRight";
    private double dStep = 0.01;        final private String dStepLabel = "dStep";
    
    private boolean bIsAxisOn = false;      final private String bIsAxisOnLabel = "bIsAxisOn";
    private boolean bIsLabelsOn = false;    final private String bIsLabelsOnLabel = "bIsLabelsOn";
    private boolean bIsFilterKeys = false;  final private String bIsFilterKeysLabel = "bIsFilterKeys";
    ...
    private void parseValue(String var, String value){
        try{
            if     (var.equalsIgnoreCase(bIsAxisOnLabel))       bIsAxisOn = Boolean.parseBoolean(value);
            else if(var.equalsIgnoreCase(bIsLabelsOnLabel))     bIsLabelsOn = Boolean.parseBoolean(value);
            else if(var.equalsIgnoreCase(bIsFilterKeysLabel))   bIsFilterKeys = Boolean.parseBoolean(value);
            else if(var.equalsIgnoreCase(dErrLeftLabel))        dErrLeft = Double.parseDouble(value);
            else if(var.equalsIgnoreCase(dErrRightLabel))       dErrRight = Double.parseDouble(value);
            else if(var.equalsIgnoreCase(dStepLabel))           dStep = Double.parseDouble(value);
            else if(var.equalsIgnoreCase(iCapCompleteLabel))    iCapComplete = Integer.parseInt(value);
            else if(var.equalsIgnoreCase(iPointsLeftLabel))     iPointsLeft = Integer.parseInt(value);
            else if(var.equalsIgnoreCase(iPointsRightLabel))    iPointsRight = Integer.parseInt(value);
            else if(var.equalsIgnoreCase(iScreenResXLabel))     iScreenResX = Integer.parseInt(value);
            else if(var.equalsIgnoreCase(iScreenResYLabel))     iScreenResY = Integer.parseInt(value);
            else if(var.equalsIgnoreCase(iTestNumTrialsLabel))  iTestNumTrials = Integer.parseInt(value);
        }catch(Exception e){
            e.printStackTrace();
    ...
    public void run(){
        ...
        if(isDebug) System.out.println(dataFilename);
    ...
    public void loadConfigurationFromFile(File configFile) {
        try{
            ...
            while((strLine = br.readLine()) != null){
                if(isDebug) System.out.println("Debug: " + strLine);
    ...
    public void loadConfigurationFromString(String str){
        ...
        for(int i=0; i<lines.length; i++){
            ...
            if(tokens.length == 2){
                try{
                    if(isDebug)System.out.println(tokens[0].trim()+"--"+tokens[1].trim());
                    parseValue(tokens[0].trim(), tokens[1].trim());
                }catch(Exception e){
...
// then passes these as necessary to the BasicJNDCond
				...
				if(tokens.length >= 4){
					if(tokens[0].equals(expCond)){
						...
						if(isDebug) System.out.println("Parsed: " + base + " " + diff + " " + isDescending + " " + scalingVal);
 ...
 // part of KeyListener
    public void keyPressed(KeyEvent e) {
        ...
        if(this.bIsFilterKeys && !isKeyAllowed(e, expCtrl)) return;
