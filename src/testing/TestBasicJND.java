...
public class TestBasicJND extends JFrame implements KeyListener{
	...
	// Constructor
	public TestBasicJND(Vector importedConditions){
	...
	public static void main(String[] args) {
		...
		double step = 0.01;
        boolean isAxisOn = false;
        boolean isLabelsOn = false;
			...
			while ((strLine = br.readLine()) != null) {
				...
				if(tokens.length >= 4){
					if(tokens[0].equals("BasicJND")){
                        ...
                        BasicJNDCondition tempCond = new BasicJNDCondition(base, diff, isDescending, pointsLeft, pointsRight, errLeft, errRight, step, isAxisOn, isLabelsOn, 1, pointSize, pointStyle, dotHue);
